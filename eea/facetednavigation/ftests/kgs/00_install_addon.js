...
casper.test.begin('Faceted Navigation Install', function(test) {
   ...
   /* submit form */
   casper.waitForSelector("form input[value='eea.facetednavigation:default']",
       function success() {
           test.assertExists("form input[value='eea.facetednavigation:default']", "eea.facetednavigation check box is present");
           this.click("form input[value='eea.facetednavigation:default']");
       },
       function fail() {
           test.assertExists("form input[value='eea.facetednavigation:default']", "eea.facetednavigation check box is present");
   });
